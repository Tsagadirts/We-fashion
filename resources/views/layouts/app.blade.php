    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <ul><a href="#" class="navbar-brand">Informations</a>
                <li><a href="#" style="text-decoration: none;">Mentions légales</a></li>
                <li><a href="#" style="text-decoration: none;">Presse</a></li>
                <li><a href="#" style="text-decoration: none;">Fabrication</a></li>
            </ul>
            <ul><a href="#" class="navbar-brand">Service client</a>
                <li><a href="#" style="text-decoration: none;">Contactez-nous</a></li>
                <li><a href="#" style="text-decoration: none;">Livraison & Retour</a></li>
                <li><a href="#" style="text-decoration: none;">Conditions de vente</a></li>
            </ul>
